...
const Product = ({post}) => {
  ...
  return (
    ...
    hover:scale-110 transition duration-300 ease-in gap-3 mt-10 ml-5
      ...
      </div>
    {
      ...
      (<button  
        ...
        font-semibold text-[12px] p-1 px-3
         uppercase hover:bg-gray-700 hover:text-white transition duration-300 ease-in'onClick={addToCart}>
      Add to Cart
      </button>)
    }
      </div>
